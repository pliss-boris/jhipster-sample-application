...
import com.quantum.demo.config.EmbeddedKafka;
import com.quantum.demo.config.KafkaSseConsumer;
import com.quantum.demo.config.KafkaSseProducer;
...
class JhdemoKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/jhdemo-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();

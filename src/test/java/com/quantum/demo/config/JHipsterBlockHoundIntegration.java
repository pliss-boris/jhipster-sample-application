...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.quantum.demo.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.quantum.demo.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
